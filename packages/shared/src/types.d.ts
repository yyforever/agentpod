...
export type PodActualStatus = 'pending' | 'running' | 'stopped' | 'exited' | 'error' | 'unknown';
export type PodEventType = 'created' | 'started' | 'stopped' | 'restarted' | 'deleted' | 'error' | 'health_check_failed' | 'config_changed';
...
export type AgentAdapter = {
    ...
    resolveContainerSpec: (config: Record<string, unknown>, platform: PlatformContext) => ContainerSpec;
};
